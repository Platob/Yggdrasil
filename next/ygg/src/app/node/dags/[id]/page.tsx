              ...
              <div key={run.id} className="nordic-card overflow-hidden">
                ...
                {expandedRun === run.id && (
                  <div className="border-t border-border px-4 pb-4 pt-3">
                    <span className="text-[10px] uppercase tracking-wider text-muted">Step Results</span>
                    {Object.keys(run.step_results).length > 0 ? (
                      <pre className="code-block p-3 mt-1 text-xs overflow-x-auto whitespace-pre-wrap">
