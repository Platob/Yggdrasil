"""Behavior tests for :class:`yggdrasil.io.primitive.xlsx_io.XlsxFile`."""
...
from yggdrasil.io.primitive.xlsx_io import XlsxFile, XlsxOptions, XlsxSheetFile
...
class TestRegistration:
    ...
    def test_registry(self) -> None:
        assert Tabular.class_for_media_type(MimeTypes.XLSX) is XlsxFile
