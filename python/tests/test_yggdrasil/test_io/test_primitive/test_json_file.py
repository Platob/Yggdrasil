"""Behavior tests for :class:`yggdrasil.io.primitive.json_file.JSONFile`."""
...
from yggdrasil.io.primitive.json_file import JSONFile, JsonOptions
...
class TestRegistration:
    ...
    def test_registry(self) -> None:
        assert Holder.class_for_media_type(MimeTypes.JSON) is JSONFile
