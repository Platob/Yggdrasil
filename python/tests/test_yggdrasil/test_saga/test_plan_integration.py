...
from yggdrasil.saga.plan import (
    ExecutionPlan,
    LazyTabular,
    PlanNode,
    SelectNode,
...
from yggdrasil.saga.plan.nodes import ScanNode
from yggdrasil.saga.plan.ops import JoinClause, TableRef
...
class TestSelectPlanNodeConversion:
    def test_to_plan_node_select(self):
        ...
        from yggdrasil.saga.expr.nodes import Column
...
class TestExpressionNodeEquality:
    def test_function_call_equality(self):
        from yggdrasil.saga.expr.nodes import FunctionCall, Column
    ...
    def test_subscript_equality(self):
        from yggdrasil.saga.expr.nodes import Subscript, Column, Literal
    ...
    def test_case_when_equality(self):
        from yggdrasil.saga.expr.nodes import CaseWhen, Comparison, Column, Literal
    ...
    def test_sort_order_equality(self):
        from yggdrasil.saga.expr.nodes import SortOrder, Column
...
class TestExpressionSQLRoundTrip:
    def test_function_call_render(self):
        from yggdrasil.saga.expr.backends.sql import to_sql
        from yggdrasil.saga.expr.nodes import FunctionCall, Column
    ...
    def test_case_when_render(self):
        from yggdrasil.saga.expr.backends.sql import to_sql, from_sql
...
class TestWalkNewNodes:
    def test_walk_function_call(self):
        from yggdrasil.saga.expr import walk, free_columns
        from yggdrasil.saga.expr.nodes import FunctionCall, Column
        fc = FunctionCall("UPPER", (Column(name="name"),))
