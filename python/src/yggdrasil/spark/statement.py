...
class SparkStatementResult(StatementResult[SparkPreparedStatement]):
    ...
    # ``_persisted_data`` (a :class:`Dataset` wrapper) is the
    ...
    def persist(
        ...
        *,
        ...
        """Stash a materialised frame on this result as a :class:`Dataset`.
    ...
    # -------------------------------------------------------------------------
    # Read hooks — forward to the held Dataset when set so callers
