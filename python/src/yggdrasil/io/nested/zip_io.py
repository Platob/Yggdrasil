...
:class:`ZipEntryFolderIO` is a :class:`Tabular` that views a name
...
from yggdrasil.data.enums import MediaType, MediaTypes, MimeTypes, Mode
...
class ZipEntryFolderIO(Tabular[ZipOptions]):
    ...
    # :class:`Tabular` — shared ``_persisted_data`` slot driver.
    ...
    def __iter__(self) -> "Iterator[Tabular]":
