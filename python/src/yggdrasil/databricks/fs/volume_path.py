...
class VolumePath(DatabricksPath):
    ...
    # ==================================================================
    # Grants — UC privilege management
    # ==================================================================
    ...
    def _grants_full_name(self) -> str:
        ...
        if not (cat and sch and vol):
            raise ValueError(
                f"Cannot manage grants on {self!r}: a volume path "
                "must include catalog, schema, and volume parts."
            )
    ...
    def revoke(self, principal: str, privileges):
        ...
        from yggdrasil.databricks.sql.grants import (
            _check_principal,
            _check_privileges,
        )
