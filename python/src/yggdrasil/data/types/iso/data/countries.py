...
Each entry is (alpha-2, alpha-3, numeric, English short name).
Source: ISO 3166-1 (2020+).
"""
from __future__ import annotations

__all__ = ["COUNTRIES", "COUNTRY_ALIASES"]
...
# Non-ISO common aliases -> alpha-2. All keys are expected to be
# upper-case, whitespace-collapsed, punctuation-stripped.
