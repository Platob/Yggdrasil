...
Each entry is (alpha-3 code, numeric, minor units, English name).
Only active fiat currencies are included. Source: ISO 4217 table A.1.
"""
from __future__ import annotations

__all__ = ["CURRENCIES", "CURRENCY_ALIASES"]


CURRENCIES: tuple[tuple[str, str, int, str], ...] = (
    ...
    ("VED", "926", 2, "Bolivar Soberano"),
    ("VES", "928", 2, "Bolivar Soberano"),
    ("VND", "704", 0, "Dong"),
    ("VUV", "548", 0, "Vatu"),
    ("WST", "882", 2, "Tala"),
...
# Common symbols and popular aliases -> alpha-3 currency code.
# All keys must be normalized (upper-case, collapsed whitespace).
